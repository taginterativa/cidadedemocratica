...
set :domain, "cidadedemocratica.org.br"
set :application, "cidade_democratica"

set :repository, "/home/desenvolvimento/projetos/cidade_democratica" # old => /var/rails/cidade_democratica
...
namespace :deploy do
  ...
  task :restart, :roles => :app do
    run "chmod -R 755 #{deploy_to}/current" # run "chmod -R 755 #{release_path}"
